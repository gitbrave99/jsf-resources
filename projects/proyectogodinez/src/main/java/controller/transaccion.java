...
public class transaccion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (accion.equalsIgnoreCase("hacertransaccion")) {

                Transaccion trans= new Transaccion();
                trans.setIdTransaccion(Integer.parseInt(request.getParameter("btnCrearTransaccion"))); 
                trans.setIdTipoTransaccion(Integer.parseInt(request.getParameter("tipotransaccion"))); 
                trans.setValor_monteario(Integer.parseInt(request.getParameter("valormonetario"))); 
